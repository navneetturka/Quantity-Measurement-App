...
import com.apps.quantityservice.unit.IMeasurable;
    ...
    public boolean isValidUnit() {
        ...
        try {
            switch (measurementType) {
                case "LengthUnit":
                    com.apps.quantityservice.unit.LengthUnit
                            .fromUnitName(unit); break;
                case "VolumeUnit":
                    com.apps.quantityservice.unit.VolumeUnit
                            .fromUnitName(unit); break;
                case "WeightUnit":
                    com.apps.quantityservice.unit.WeightUnit
                            .fromUnitName(unit); break;
                case "TemperatureUnit":
                    com.apps.quantityservice.unit.TemperatureUnit
                            .fromUnitName(unit); break;
